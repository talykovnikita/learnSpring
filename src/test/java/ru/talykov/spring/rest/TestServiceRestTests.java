...
class TestServiceRestTests extends AbstractTest {
  ...
  void checkGetIndexResponseTest() {
    ...
    IndexResponse expectedResponse =
        testServiceManager.buildIndexResponse(HttpMethod.GET, StatusEnum.WORKING);
  ...
  void checkPostIndexResponseTest() {
    ...
    var expectedResponse =
        testServiceManager.buildIndexResponse(HttpMethod.POST, StatusEnum.WORKING);
  ...
  void checkGetInternalErrorResponseTest() {
    ...
    ErrorResponseException actualException =
        assertThrows(
    ...
    InternalErrorResponse expectedResponse =
        testServiceManager.buildInternalErrorPageResponse(HttpMethod.GET, StatusEnum.BROKEN);

    testServiceVerifier.assertInternalErrorResponse(expectedResponse, actualException);
    testServiceVerifier.assertStatusCode(
        actualException.getStatusCode(), HttpStatus.INTERNAL_SERVER_ERROR.value());
  }
}
