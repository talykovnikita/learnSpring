...
public class TestServiceVerifier {
  ...
  public void assertIndexResponseIgnoreHeadersField(
      IndexResponse expectedResponse, IndexResponse actualResponse) {
  ...
  public void assertInternalErrorResponse(
      InternalErrorResponse expectedResponse, ErrorResponseException responseException) {
    InternalErrorResponse actualResponse =
